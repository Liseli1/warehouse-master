...
-- ----------------------------
INSERT INTO `bus_goods` VALUES (1, '娃哈哈', 3, '武汉', '120ML', '瓶', 'PH12345', 'PZ1234', '小孩子都爱的', 2, 472, 10, '2020-02-24/99F329D96E06449E9A5D613B1D3FA7DD.jpg', 1);
...
CREATE TABLE `bus_sales`  (
  ...
  `goodsid` int(11) NULL DEFAULT NULL,
  `available` int(4) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `bus_sales` VALUES (1, 4, '支付宝', '2020-01-21 03:04:52', '落亦-', 15, '士大夫士大夫', 60.00, 1, NULL);
INSERT INTO `bus_sales` VALUES (2, 8, '支付宝', '2020-01-21 03:05:13', '落亦-', 10, '萨的发生地方', 100.00, 2, NULL);
INSERT INTO `bus_sales` VALUES (8, 1, '支付宝', '2023-12-03 14:29:15', '超级管理员', 1, '', 123.00, 1, NULL);
...
CREATE TABLE `sys_log`  (
  ...
  `indata` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
...
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES (1, '超级管理员system', 'Sales(id=8, customerid=1, paytype=支付宝, salestime=Sun Dec 03 22:29:15 CST 2023, operateperson=超级管理员, number=1, remark=, saleprice=123.0, goodsid=1, customername=null, goodsname=null, size=null, available=null)', 'addSales', '2023-12-03 22:29:15', '添加成功', '127.0.0.1');
...
INSERT INTO `sys_loginfo` VALUES (289, '超级管理员-system', '0:0:0:0:0:0:0:1', '2023-12-03 14:26:57');
