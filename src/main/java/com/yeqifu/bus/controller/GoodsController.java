...
public class GoodsController {
    ...
    public JSONObject showAllGood(){
        JSONObject data=new JSONObject();
        ShowGoodOut out=goodsService.showAllGood();
        data.put("series",out.getSeries().getSeriesData());
        data.put("xAxis",out.getXAxis());
        return data;
    }

    @RequestMapping("/showGoodsSales")
    public JSONObject showGoodsSales(){
        JSONObject data=new JSONObject();
        ShowGoodOut out=goodsService.AllGoodsSale();
        data.put("legend",out.getLegend());
        data.put("series",out.getSeries());
        data.put("xAxis",out.getXAxis());
        return data;
    }
